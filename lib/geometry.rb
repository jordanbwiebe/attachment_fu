...
class Array
  ...
  def /(geometry)
    ...
    raise ArgumentError, "Must pass a valid geometry string or object" unless geometry.is_a?(String) || geometry.is_a?(AttachmentFu::Geometry)
    geometry = AttachmentFu::Geometry.from_s(geometry) if geometry.is_a?(String)
